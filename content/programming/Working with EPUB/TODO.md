- [ ] Implementing POC
	- [ ] Create a project involving FE, BE and following use cases:
		- [ ] Upload an EPUB book
		- [ ] View the list of uploaded books
		- [ ] Open book
		- [ ] View TOC
		- [ ] View page
	- [ ] On a EPUB book page create:
		- [ ] Select text functionality
		- [ ] Make a note functionality
		- [ ] View/Edit note functionality
		- [ ] Delete Note functionality
- [ ] Implementing Design Doc
	- [ ] Learning RFC and Design Doc building Guides
	- [ ] Learning W3C EPUB specs
	- [ ] Creating Design Doc
- [ ] Implementing MVP
	- [ ] Review POC architecture and refactor if need
	- [ ] Improve existing features, or reuse existing modules
	- [ ] Implement MVP use-cases according to Design Doc
- [ ] ...
...
# Current Stack
 ...
 - Prizma/Prizmabox
 - Bun/Elysia/Eden+treaty/BetterAuth
 - Angular(SCSS)/PrimeNG
